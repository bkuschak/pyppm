...
class ppm_analysis:
    ...
    def analyze(self, plot_fname=None, wavfilename=None):
        ...
        (self.f0, self.A0) = pyppm.fft(self.t0, self.a0)
        (self.f1, self.A1) = pyppm.fft(self.t1, self.a1)
        (self.f1f, self.A1f) = pyppm.fft(self.t1, self.a1f)
    ...
    def multiplot_results(self, plot_fname=None):
        ...
        plt.plot(np.array(self.f0), np.array(self.A0), 'b', label='background')
        plt.plot(np.array(self.f1), np.array(self.A1), 'r', label='measurement')
        plt.plot(np.array(self.f1f), np.array(self.A1f), 'g', label='post-filtered')
